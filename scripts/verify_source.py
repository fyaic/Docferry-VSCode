...
def verify_runtime() -> None:
    ...
    if provenance.get("version") != "0.4.4":
        raise SystemExit("Bundled Agent Kit provenance must remain at 0.4.4.")
...
def main() -> int:
    ...
    verify_runtime()
    verify_workflows()
    print(json.dumps({"ok": True, "source_files": len(source_files()), "agent_kit": "0.4.4"}))
    return 0
